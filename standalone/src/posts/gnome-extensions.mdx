...
description: aaa
date: '2020-09-24'
coverImage: '/posts/gnome-extensions.jpg'
...
![Dash to Dock](/posts/gnome-extensions/Screenshot-from-2020-09-23-23-32-23-1024x576.png)
...
![Dash to Panel](/posts/gnome-extensions/Screenshot-from-2020-09-23-23-39-11-1024x576.png)
...
```css
# replace 'underline' with 'none' .pcalendar-holiday,
...
```css
## replace '0.5' .panel-transparency {
...
[pop-shell](/posts/pop-shell)

[نصب Pop Shell](https://github.com/pop-os/shell#installation)

## قلم خفن نویس | Draw On You Screen:

![Draw On You Screen](/posts/gnome-extensions/Screenshot-from-2020-09-24-00-24-15-1024x576.png)
